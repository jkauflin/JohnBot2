...
board.on("error", function (err) {
    console.log("*** Error in Board, err = "+err);
    boardReady = false;
...
function createComponents() {
    ...
    */
    ...
    log("Head pos = " + Math.round(headServo.position));
    log("Arm pos = " + Math.round(armServo.position));
    headStartPos = Math.round(headServo.position);
    armStartPos = Math.round(armServo.position);
